...
public class PassengerController {
	...
	// fetching passenger details by name using get mapping
	@GetMapping("getpbyname/{pname}")
	public ResponseEntity<Passenger> getPByName(@PathVariable("pname") String pname) {
		return new ResponseEntity<Passenger>(ps.getPassengerByName(pname), HttpStatus.OK);
	}

	// fetching passenger details by phone using get mapping
	@GetMapping("getpbyphone/{phone}")
	public ResponseEntity<Passenger> getPBy(@PathVariable("phone") long phone) {
		return new ResponseEntity<Passenger>(ps.getPassengerByPhone(phone), HttpStatus.OK);
	}
