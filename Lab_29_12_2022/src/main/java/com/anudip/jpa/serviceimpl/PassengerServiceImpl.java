...
public class PassengerServiceImpl implements PassengerService {
	...
	@Override
	// remove passenger details based on id from table using deleteById()
	...
	@Override
	public Passenger getPassengerByName(String pName) {
		return passRepository.getPassengerByName(pName);
	}

	@Override
	public Passenger getPassengerByPhone(long phone) {
		return passRepository.getPassengerByPhone(phone);
	}
